namespace SaintJosephsHospitalHealthMonitorApp
{
    partial class DebugForm
    {
        ...
        private Label lblDashboardNote;
        private CheckBox chkPharmacist;
        private CheckBox chkDoctor;
        private CheckBox chkReceptionist;
        private CheckBox chkAdmin;
        private Label lblDashboardTitle;
        private TabPage tabDefaultUsers;
        private Label lblDefaultUsersWarning;
        private Label lblPatientDetails;
        private CheckBox chkCreatePatient;
        private Label lblDoctorDetails;
        private CheckBox chkCreateDoctor;
        private Label lblPharmacistDetails;
        private CheckBox chkCreatePharmacist;
        private Label lblReceptionistDetails;
        private CheckBox chkCreateReceptionist;
        private Label lblAdminDetails;
        private CheckBox chkCreateAdmin;
        private Label lblHeadadminDetails;
        private Label lblHeadadminTitle;
        private Label lblDefaultUsersInfo;
        private Label lblDefaultUsersTitle;
        private TabPage tabRoleCreation;
        private Label lblRoleCreationNote;
        private Label lblAllowPatientDetails;
        private CheckBox chkAllowPatient;
        private CheckBox chkAllowPharmacist;
        private Label lblAllowDoctorDetails;
        private CheckBox chkAllowDoctor;
        private Label lblAllowReceptionistDetails;
        private CheckBox chkAllowReceptionist;
        private Label lblAllowAdminDetails;
        private CheckBox chkAllowAdmin;
        private Label lblRoleCreationInfo;
        private Label lblRoleCreationTitle;
